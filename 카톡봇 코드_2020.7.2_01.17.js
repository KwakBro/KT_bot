...
const BufferdReader = java.io.BufferedReader;

function ignoreSsl() throws Exception{
      ...
      /////////////////////////////////////////////////////////////////////////////////////////// k
       ...
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// k
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// k
           ...
           var n = 0;
           while(n < ((arr[1]*1)*12) ){	// 5초마다 체크, 사용자는 n분동안 알림 받을지 입력.
              n +=1;
              ...
              if(temp.indexOf("[" + params.sender + "]") != -1){
                ...
                if(T3[0] == ""){
                  params.replier.reply("알람할 종목 없음. 종료합니다.");
                  return;
                }
       ...
       ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// k
       ...
       else if( (arr[0] == "/부동산검색")){	///////// 미완성 /////////
         //var land_text = Utils.getWebText("https://new.land.naver.com/complexes/103198?ms=35.995593,128.401688,15&a=APT:ABYG:JGC&e=RETAIL");
         //var land_text = Utils.getWebText("https://m.land.naver.com/complex/info/100563?tradTpCd=A1:B1:B2:B3&ptpNo=&bildNo=&articleListYN=Y");
         //land_text.replace(/(<([^>]+)>)/g, "");
         
         try{
           
         //params.replier.reply( land_text );
         let apiURL = "https://openapi.naver.com/v1/papago/n2mt";
         let url = new URL(apiURL);
         let con = url.openConnection();
         
         } catch(e){
           params.replier.reply(e);
           return;
         }
        ...
        else if( (arr[0] == "/게시판업데이트")){	///////// 미완성 /////////
          try{
             let coin_URL = "https://community.coinbit.co.kr/bbs/board.php?bo_table=free&page=";
             let url = new URL(coin_URL)
             let con =  url.openConnection();
             ignoreSsl();
             //params.replier.reply(land_text);
             } catch (e){
